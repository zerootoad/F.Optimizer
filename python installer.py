...
def next_step(folder):
    while True:
        ...
        print("1. Install Francesco Optimizer")
        print("2. Uninstall Francesco Optimizer")
        print("3. Exit")
...
def install(folder):
    ...
    print("Installation successful: Francesco Optimizer has been added to your Roblox.\n")
    time.sleep(3)
...
def uninstall(folder):
    ...
    if found:
        print("Uninstallation successful: Francesco Optimizer has been removed from your Roblox.\n")
    time.sleep(3)
    os.system('cls' if os.name == 'nt' else 'clear')
